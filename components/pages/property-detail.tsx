...
export function PropertyDetailPage() {
  ...
  return <>
    ...
    <div className="kpi-grid">
      ...
      <Kpi label="累計入金額" value={yen(paid)} tone="good" />
      <Kpi label="回収率" value={recovery == null ? "算出不可" : percent(recovery)} sub={recovery != null && recovery >= 1 ? "元本回収済み" : undefined} tone={recovery != null && recovery >= 1 ? "good" : undefined} />
    </div>
